 ...
 *
 */
public class DistanceOfTheCotiY implements Heuristique {
	...
	public int computesWeight(Grille g) {
		...
		for (int i = 0; i < Arbre.SIZE; i++) {
			...
			distance += idx % Arbre.DIM + Math.abs(i % Arbre.DIM - idx % Arbre.DIM)
	...
	public String toString() {
		return "[Heuristique= Distance of the CotiY]";
	}
